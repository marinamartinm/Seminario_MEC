...
ggplot(data = pib2020, aes(x=Comunidad, y = Total)) +
  ...
  geom_text(data = maximos, aes(label = Total, y = Total), vjust = -0.5,size=2)+
...
ggplot(data = pib2019, aes(x=Comunidad, y = Total)) +
  ...
  geom_text(data = maximos2019, aes(label = Total, y = Total), vjust = -0.5,size=2)+
...
ggplot(data = pib2018, aes(x=Comunidad, y = Total)) +
  ...
  geom_text(data = maximos2018, aes(label = Total, y = Total), vjust = -0.5,size=2)+
...
```
```{r}
Dep_pib <- full_join(Depresion_final, PIBMedio, by = "Comunidad")
Dep_pib <- Dep_pib %>%
  select(Valor_Depresion,Comunidad,MediaPIB)
