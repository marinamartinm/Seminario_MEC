...
```{r}
levels(factoresion_final$Prevalencia))
...
```{r}
depr_y_suicidio <- right_join(Depresion_filt, Suicidio_final, by = "Comunidad")  #Unimos los dataset Depresion_final y Suicidio_final mediante la columna común Cominudad.
depr_y_suicidio
...
```
```{r}
levels(factor(depr_suicidio$Comunidad))
