...
DepresionCCAA
DepresiónCCAA.csv <- read_delim("Data/DepresionCCAA.csv", delim = ";", show_col_types = FALSE)
DepresiónCCAA.csv
```
...
EnfermedadesCronicas.csv <- read_delim("Data/EnfermedadesCronicas.csv", delim = ";", show_col_types = FALSE)
EnfermedadesCronicas.csv
```
...
```{r}
Suicidio <- read_delim("Data/Suicidio.csv", delim = ";", show_col_types = FALSE)
Suicidio
