...
### 2º CONJUNTO DE DATOS: Enfermedades Mentales por CCAA
```{r, echo = FALSE, message=FALSE, warning=FALSE}
...
### 3º CONJUNTO DE DATOS: PIB por CCAA
```{r, echo = FALSE, message=FALSE, warning=FALSE}
...
Hay que tener en cuenta que los valores muestran el porcentaje de crecimiento y decrecimiento que sufrió cada CCAA en ralcion a PIB.
...
```
Al comparar los resultados de las tablas y los graficos 
