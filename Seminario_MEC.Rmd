...
```{r}
depr_y_suicidio <- right_join(Depresion_final, Suicidio_final, by = "Comunidad")  #Unimos los dataset Depresion_final y Suicidio_final mediante la columna común Cominudad.
depr_y_suicidio
unique(depr_suicidio)  #Eliminamos filas duplicadas.
