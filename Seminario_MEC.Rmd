...
```
```{r}
grafico <- ggplot(depr_suicidio, aes(x = Sexo_Depresion, y = Valor_Suicidio, fill = Sexo_Depresion)) +
  geom_bar(stat = "identity", fill = "chartreuse2") +
  labs(title = "Depresión vs Suicidio por sexo", x = "Sexo", y = "Valor suicidio")

grafico + coord_polar(theta = "y")
```
...
grafico_Suicidio_Sexo <- ggplot(data = depr_suicidio, aes(x = "", y = Porcentaje, fill = Sexo_Depresion)) +
  geom_bar(stat = "identity", width = 1) +
  coord_polar(theta = "y") +
  labs(title = "Ideación Suicida en Jóvenes (2023)",
       fill = "Frecuencia",
